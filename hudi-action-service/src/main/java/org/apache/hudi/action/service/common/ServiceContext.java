...
public class ServiceContext {
  ...
  private final static ConcurrentHashMap<String, String> runningInstance = new ConcurrentHashMap<>();
  private final static ConcurrentHashMap<String, Long> pendingInstances = new ConcurrentHashMap<>();
