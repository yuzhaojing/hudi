...
public class HoodieJavaTableServiceClient<T extends HoodieRecordPayload> extends BaseTableServiceClient<List<WriteStatus>> {

  protected HoodieJavaTableServiceClient(HoodieEngineContext context, HoodieWriteConfig clientConfig, HoodieMetrics metrics) {
